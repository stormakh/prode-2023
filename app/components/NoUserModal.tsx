...
export default function Example({endModal} : {endModal: () => void}) {
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Para poder votar tenes que estar registrado. Si ya tenes una cuenta, inicia sesion. Si no, crea una cuenta.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 px-4 py-3  gap-y-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <Link
                    ...
                    onClick={() => setOpen(false)}
                  >
                    Regristrate con google
                  </Link>
                  <button
                    type="button"
                    className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                    onClick={() => {setOpen(false), endModal()}}
                    ref={cancelButtonRef}
                  >
                    Atras
                  </button>

...
export default function SignInModal({ endModal }: { endModal: () => void }) {
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Para poder seguir tenes que estar registrado. Si ya
                          tenés una cuenta, inicia sesión. Si no, creá una
                          cuenta.
                        </p>
                      </div>
                    </div>

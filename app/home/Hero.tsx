	...
	return (
		<div className="bg-white">
				...
				>
					<div className="flex lg:flex-1">
						<a href="#" className="-m-1.5 p-1.5">
							<span className="sr-only">ProdeArg</span>
							{/* <img
			...
			<div className="relative isolate px-6 pt-14 lg:px-8">
              ...
              Anunciando las nuevas noticias que lanzamos.{" "}
                ...
                Read more <span aria-hidden="true">&rarr;</span>
					...
					<div className="text-center">
						...
						<p className="mt-6 text-lg leading-8 text-gray-600">
							Prode Arg es el{" "}
							<b>Prode de las Elecciones 2023 🇦🇷</b> que te
							permite <b>compartir con tus amigos</b> como piensa
							cada uno que resultan las elecciones
						</p>
